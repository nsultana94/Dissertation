...
#             new_weights.append(0)
#         elif label == 5:
#             new_weights.append(total_weight * (1 / weight) * 5 * 0.5)
#         else:
#             new_weights.append(total_weight * (1 / weight) * 0.5)
...
#         # print(image_0.shape, mask.shape)
...
#         cell_state_loss = cell_loss(c_next, c_original)
...
#         x_tilda = self.encoder(image_2)
#         feature_vector = x_tilda[5]
#         feature_vectors.append(x_tilda)
...
# for name,param in convlstms.named_parameters():
#     param.requires_grad = False
...
# checkpoint = torch.load(f'{DATA_URL}Models/testing4.pt')
...
# train_function(trainloader, initialiser, optimizer)
